...
﻿
app.get("/", (req, res) => res.send("Tesla TurOptimal V6 SMART ROUTE ENGINE backend"));
﻿
app.get("/health", (req, res) => {
  res.json({
    ok: true,
    version: "6.0-smart-route-engine",
...
﻿
app.listen(PORT, () => console.log("Tesla TurOptimal V6 SMART ROUTE ENGINE backend on port " + PORT));
